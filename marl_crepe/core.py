...
def build_and_load_model(model_path, model_capacity='full'):
    """
...
def get_activation(audio, sr, model_path, model_capacity='full', center=True, step_size=10,
    ...
    """
    model = build_and_load_model(model_path, model_capacity)
...
def process_file(file, model_path, output=None, model_capacity='full', viterbi=False,
